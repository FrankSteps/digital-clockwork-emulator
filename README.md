...
2. As a first step toward turning this project into a personal hardware lab, I, Francisco (@FrankSteps), am transcribing the entire logic of the project into Verilog. My friend @LuccaPedreira
