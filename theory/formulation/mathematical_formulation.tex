...
O \textit{a digital clockwork} é um relógio digital implementado inteiramente a partir de componentes lógicos discretos, como portas lógicas, flip-flops, comparadores e contadores. Este trabalho tem como objetivo transcrever, com rigor matemático, a lógica de funcionamento desses circuitos para um modelo formal, utilizando conceitos de linguagens formais para descrever o comportamento de cada componente e suas interações. Essa formalização estabelece uma ponte entre a implementação simulada em C++ e sua futura descrição em Verilog, possibilitando posteriormente sua verificação formal em Rocq.
...
\section{Aquisição e digitalização do sinal da rede elétrica}
...
\section{Divisão de frequência com o 4040}
\section{}
